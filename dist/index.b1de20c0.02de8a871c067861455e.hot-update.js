...
const parseData = deadlines => {
  ...
  let passedCount = 0;
  let boxes = [];
  console.log(dayjs__WEBPACK_IMPORTED_MODULE_1___default()(startDate).fromNow());
  ...
  for (let i = 1; i <= numOfBoxes; i++) {
    ...
    if (startDate > now) {
      ...
      boxes.push({
        passed: true,
        info: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(startDate).toNow()
      });
    }
  }
...
//# sourceMappingURL=index.b1de20c0.02de8a871c067861455e.hot-update.js.map