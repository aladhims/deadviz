...
const Submission = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyledForm, {
    ...
    hasFeedback: true,
    dependencies: ['end'],
    help: "The start date should be before end date",
    rules: [{
      type: 'object',
      required: true,
    ...
    hasFeedback: true,
    dependencies: ['start'],
    help: "The end date should be after start date",
    rules: [{
      type: 'object',
      required: true,
    ...
    defaultValue: moment__WEBPACK_IMPORTED_MODULE_2___default()(new Date().setFullYear(today.getFullYear())),
    className: "full-width",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.834c56f7.f76d5646ef10ce7f9d62.hot-update.js.map