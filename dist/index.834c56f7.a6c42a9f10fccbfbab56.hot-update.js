...
const Menu = () => {
  ...
  const handlePin = ({
    ...
    const newDeadlines = [...deadlines.slice(0, index), ...deadlines.slice(index + 1)];
    console.log(index, pinnedDeadline, newDeadlines);
    return; // check if there is no existing pinned deadline
...
//# sourceMappingURL=index.834c56f7.a6c42a9f10fccbfbab56.hot-update.js.map