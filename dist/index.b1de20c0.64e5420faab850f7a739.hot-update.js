...
const parseData = deadlines => {
  ...
  let diff = dayjs__WEBPACK_IMPORTED_MODULE_1___default.a.duration(startDate.diff(endDate));
  let numOfBoxes = diff.asDays();
  console.log(numOfBoxes);

  if (numOfBoxes > 30) {
    summaryUnit = "weeks";
    numOfBoxes = diff.asWeeks();
  }
...
//# sourceMappingURL=index.b1de20c0.64e5420faab850f7a739.hot-update.js.map