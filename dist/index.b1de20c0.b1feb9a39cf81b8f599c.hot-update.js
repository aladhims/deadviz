...
const parseData = deadlines => {
  ...
  console.log(summaryUnit, numOfBoxes);
  const now = dayjs__WEBPACK_IMPORTED_MODULE_1___default()();
  let passedCount = 0;
  let boxes = [];

  for (let i = 1; i <= numOfBoxes; i++) {
    const remainingTime = startDate.fromNow();
    const passedTime = startDate.toNow();
...
//# sourceMappingURL=index.b1de20c0.b1feb9a39cf81b8f599c.hot-update.js.map