...
const FadeIn = styled_components__WEBPACK_IMPORTED_MODULE_2__["keyframes"]`
      0% {
        opacity: 0;
        transform: scale(0);
      }
...
`;
const PassedBox = Object(styled_components__WEBPACK_IMPORTED_MODULE_2__["default"])(Box)`
...
}, deadline.title), deadline.boxes.map((item, index) => item.passed ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(PassedBox, {
  key: index,
  __self: undefined,
  __source: {
    fileName: _jsxFileName,
...
//# sourceMappingURL=index.b1de20c0.a38c2d72514245be3043.hot-update.js.map