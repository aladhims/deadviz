...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'day'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const Submission = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyledForm, {
    ...
    initialValue: !(function webpackMissingModule() { var e = new Error("Cannot find module 'day'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(),
    hasFeedback: true,
    dependencies: ['end'],
    rules: [{
      type: 'object',
    ...
    defaultValue: !(function webpackMissingModule() { var e = new Error("Cannot find module 'day'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(),
    ...
    hasFeedback: true,
    initialValue: !(function webpackMissingModule() { var e = new Error("Cannot find module 'day'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())().add(1, 'y'),
    dependencies: ['start'],
    rules: [{
      type: 'object',
      required: true,
    ...
    defaultValue: !(function webpackMissingModule() { var e = new Error("Cannot find module 'day'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())().add(1, 'y'),
    className: "full-width",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.834c56f7.ab9bb299397f085799b1.hot-update.js.map